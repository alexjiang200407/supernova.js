...
export function LensFlareEffect(
  ...
  const lensFlareParams = {
    ...
    colorGain: colorGain !== undefined ? colorGain : new THREE.Color(255, 255, 255),
    starPoints: starPoints !== undefined ? starPoints : 5.0,
    glareSize: glareSize !== undefined ? glareSize : 0.01,
    flareSize: flareSize !== undefined ? flareSize : 0.001,
    flareSpeed: flareSpeed !== undefined ? flareSpeed : 0.4,
    flareShape: flareShape !== undefined ? flareShape : 0,
